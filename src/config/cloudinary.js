...
export const CATEGORY_TO_ACCOUNT_MAP = {
  ...
  tops: CLOUDINARY_ACCOUNTS.TOPS_KURTIS,
  ...
  one_piece_dresses: CLOUDINARY_ACCOUNTS.DRESSES_ONEPIECE,
  dresses: CLOUDINARY_ACCOUNTS.DRESSES_ONEPIECE,
  dress: CLOUDINARY_ACCOUNTS.DRESSES_ONEPIECE,
  bottom: CLOUDINARY_ACCOUNTS.BOTTOMS_SHORTS,
  bottoms: CLOUDINARY_ACCOUNTS.BOTTOMS_SHORTS,
  shorts: CLOUDINARY_ACCOUNTS.BOTTOMS_SHORTS,
  denim: CLOUDINARY_ACCOUNTS.BOTTOMS_SHORTS,
  coord_set: CLOUDINARY_ACCOUNTS.TRADITIONAL_OTHER,
  coord_sets: CLOUDINARY_ACCOUNTS.TRADITIONAL_OTHER,
  coord_ethnic: CLOUDINARY_ACCOUNTS.TRADITIONAL_OTHER,
  traditional: CLOUDINARY_ACCOUNTS.TRADITIONAL_OTHER,
  ethnic: CLOUDINARY_ACCOUNTS.TRADITIONAL_OTHER,
  other: CLOUDINARY_ACCOUNTS.TRADITIONAL_OTHER,
  others: CLOUDINARY_ACCOUNTS.TRADITIONAL_OTHER,
};
