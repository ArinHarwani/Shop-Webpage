...
const VALID_TYPES = [
  'top', 'tops', 'bottom', 'bottoms', 'shorts', 'long_dress', 'one_piece',
  'one_piece_dresses', 'dress', 'dresses', 'coord_set', 'coord_sets',
  'coord_ethnic', 'traditional', 'ethnic', 'kurti', 'other', 'others'
];
